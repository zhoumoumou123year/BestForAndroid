...
import com.bestfor.android.listener.IGetBitmapListener;
import com.bestfor.android.listener.IGetDrawableListener;
import com.bestfor.android.listener.IImageLoaderListener;
import com.bestfor.android.listener.ImageSize;
import com.bestfor.android.okhttp.OnGlideImageViewListener;
import com.bestfor.android.okhttp.OnProgressListener;
import com.bestfor.android.okhttp.ProgressManager;
import com.bestfor.android.tranform.BlurBitmapTranformation;
import com.bestfor.android.tranform.GlideCircleTransformation;
import com.bestfor.android.tranform.RoundBitmapTranformation;
...
public class GlideImageLoaderClient implements IImageLoaderClient {
    ...
    public RequestOptions circleRequestOptions() {
        return requestOptions().transform(new GlideCircleTransformation());
    }
    ...
    public RequestOptions roundRequestOptions(int radius) {
        return requestOptions().transform(new RoundBitmapTranformation(radius));
    }
    ...
    public void displayCircleImage(Context context, String url, ImageView imageView) {
        GlideApp.with(context).load(url).diskCacheStrategy(DiskCacheStrategy.AUTOMATIC).apply(circleRequestOptions()).into(imageView);
    }
    ...
    public void displayCircleImage(Activity activity, String url, ImageView imageView, int defRes) {
        GlideApp.with(activity).load(url).diskCacheStrategy(DiskCacheStrategy.DATA).apply(circleRequestOptions(defRes, defRes)).into(imageView);
    }
